...
export const useCourseProgressData = (courseId, chapterId) => {
  ...
  const dummyCourses = [
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          sectionDescription:
            "Study cutting-edge machine learning algorithms and their implementations.",
          chapters: [
            {
              chapterId: "i9j0k1l2-m3n4-o5p6-q7r8-s9t0u1v2w3x4",
              type: "Video",
    ...
    },
    {
      ...
      description:
        "Learn the basics of data science, including statistics, data visualization, and machine learning.",
      ...
      sections: [
        {
          ...
          sectionDescription:
            "Learn the basics of data science and its applications.",
          chapters: [
            {
              chapterId: "g7h8i9j0-k1l2-m3n4-o5p6-q7r8s9t0u1v2",
              type: "Video",
  ...
  const updateChapterProgress = (sectionId, chapterId, completed) => {
    setUserProgress((prevProgress) => {
      if (!prevProgress) return prevProgress;

      const updatedSections = [...prevProgress.sections];
      ...
      if (sectionIndex === -1) {
        ...
        const chapterIndex = updatedSections[sectionIndex].chapters.findIndex(
          (c) => c.chapterId === chapterId
        );

        if (chapterIndex === -1) {
          updatedSections[sectionIndex].chapters.push({ chapterId, completed });
        } else {
          updatedSections[sectionIndex].chapters[chapterIndex].completed =
            completed;
        }
      }
  ...
  return {
    user: { id: "dummy-user-id" }, // Dummy user data
    courseId,
    chapterId,
    course,
    userProgress,
